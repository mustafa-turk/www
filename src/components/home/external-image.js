...
function ExternalImage({ sourceUrl, imgSrc, appUrl, isComingSoon }) {
  return (
    <div className='mb-4'>
      ...
      <div className='flex gap-2'>
        {isComingSoon ? (
          <button
            disabled
            className='border border-neutral-800 rounded-lg text-neutral-400 flex justify-center items-center px-4 text-sm py-1'
          >
